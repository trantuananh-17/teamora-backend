...
import { notificationRepository, type NotificationWithRecipient } from "./notification.repository"

export type NotificationChannel = "email" | "teams" | "in_app"
export type NotificationTemplate =
	"registration_confirmed" | "information_published" | "assignment_changed"
